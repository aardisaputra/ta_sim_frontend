  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>MACD Options</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form>
          <Form.Group controlId="slow">
            <Form.Label>Slow Period</Form.Label>
            <Col>
              <Form.Control
                type="text"
                placeholder="26"
          ...
          <Form.Group controlId="fast">
            <Form.Label>Fast Period</Form.Label>
            <Col>
              <Form.Control
                type="text"
                placeholder="12"
          ...
          <Form.Group controlId="signal">
            <Form.Label>Signal Period</Form.Label>
            <Col>
              <Form.Control
                type="text"
                placeholder="9"
